package de.igloffstein.maik.arevelation.activities;
 ...
 */
public class ARevelationSettingsActivity extends AppCompatPreferenceActivity {
    ...
    public static class SecurityPreferenceFragment extends PreferenceFragment {
        ...
        public boolean onOptionsItemSelected(MenuItem item) {
            int id = item.getItemId();
            if (id == android.R.id.home) {
                startActivity(new Intent(getActivity(), ARevelationSettingsActivity.class));
                return true;
            }
